...
class BandsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        populateDiscography(radiohead, albums: [theBends, okComputer, amnesiac, inRainbows])
        ...
        populateDiscography(beatles, albums: [sp, revolver, wa])
        ...
        populateDiscography(rem, albums: [green, document])
        ...
        populateDiscography(u2, albums: [joshuaTree, war])
    ...
    func populateDiscography(beatles: Band, albums: [Album]) {
        for album in albums {
            beatles.addAlbum(album)
        }
    }
    /*
